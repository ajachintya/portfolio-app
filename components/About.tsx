  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="-mb-20 mt-10 md:mt-0 md:mb-0 flex-shrink-0 w-20 h-20 sm:w-44 sm:h-44 rounded-full object-cover md:rounded-lg 
                md:w-60 md:h-60 xl:w-[250px] xl:h-[250px]"
      />
      <div className="space-y-6 lg:space-y-10 px-0 md:px-10">
        <h4 className="sm:text-sm md:text-lg lg:text-2xl font-semibod">
          Here is a{" "}
        ...
        >
          <button className="heroButton mt-10 text-xs">
            Download CV
          </button>
        </a>
      </div>
